        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Sunergy360</span>
                <div className="text-xs text-slate-500">AI Solar Intelligence</div>
              </div>
            </div>
            
            <div className="hidden md:flex items-center space-x-8">
              <button className="text-orange-600 font-semibold">Solutions</button>
              <button className="text-slate-600 hover:text-slate-900 font-medium">Technology</button>
              <button className="text-slate-600 hover:text-slate-900 font-medium">About</button>
              <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:shadow-lg transition-all">
                Get Started
              </button>
            </div>
          </div>
